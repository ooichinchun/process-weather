...
data_folder = '/mnt/data/co-develop/data/radar/'
save_folder = '/mnt/data/co-develop/downsample_data/radar/'

X_grid_radar = np.load(data_folder + 'X_interp_grid.npy')
Y_grid_radar = np.load(data_folder + 'Y_interp_grid.npy')
...
output_filename = save_folder + 'radar_array_' + year_month + '.npy'
